...
model_path_list = [
    ...
    "/home/user/Paint-by-Example/experiments/fine_tune/livart_sofa/last.ckpt",
    "/home/user/Paint-by-Example/experiments/fine_tune/mask_augmentation/mefema_sofa/2023-01-17T11-57-11_mask_augmentation_fine_tune/checkpoints/epoch=000007.ckpt",
    "/home/user/Paint-by-Example/experiments/fine_tune/cloud_lamp/last.ckpt",
    "/home/user/Paint-by-Example/experiments/fine_tune/inocent_bed/last.ckpt",
...
model_list = []
sampler_list = []
class_list = ['sofa', 'sofa', 'sofa', 'lamp', 'bed']
...
try:
    image_blocks.launch(server_port=1784, server_name="0.0.0.0", share=True)
