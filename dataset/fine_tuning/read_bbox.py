...
def main():
    images_path = "/home/user/Paint-by-Example/dataset/fine_tuning/fabric_sofa/raw"
    ...
    for path, file_name in tqdm(zip(images_path, file_list), total=len(images_path)):
        ...
        try:
            ...
            continue
        if len(bboxes) > 0:
            with open("/home/user/Paint-by-Example/dataset/fine_tuning/fabric_sofa/annotations/" + file_name.split(".")[0] + '.txt', 'w',
                      encoding='utf-8') as f:
