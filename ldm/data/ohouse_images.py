...
class OhouseImageDataset(data.Dataset):
    def __init__(self, state, arbitrary_mask_percent=0, dataset_ratio=(0.95, 0.025, 0.025), class_label_exist=False,
                 **args
                 ):
        self.state = state
        self.args = args
        ...
        if state == "train":
            ...
            per_dir_file_list = per_dir_file_list[start_index:end_index]  # 10%
            for file_name in per_dir_file_list:
                if file_name not in bad_list:
                    self.bbox_path_list.append(os.path.join(bbox_dir, file_name))
        else:
    ...
    def __getitem__(self, index):
        ...
        if not os.path.isfile(os.path.join('/home/user/Paint-by-Example/dataset/ohouse_images/raw', file_name)):
            file_name = os.path.splitext(os.path.basename(bbox_path))[0] + '.png'
        if not os.path.isfile(os.path.join('/home/user/Paint-by-Example/dataset/ohouse_images/raw', file_name)):
            file_name = os.path.splitext(os.path.basename(bbox_path))[0] + '.JPG'
        if not os.path.isfile(os.path.join('/home/user/Paint-by-Example/dataset/ohouse_images/raw', file_name)):
            file_name = os.path.splitext(os.path.basename(bbox_path))[0] + '.jpeg'
        if not os.path.isfile(os.path.join('/home/user/Paint-by-Example/dataset/ohouse_images/raw', file_name)):
            file_name = os.path.splitext(os.path.basename(bbox_path))[0] + '.JPEG'
        if not os.path.isfile(os.path.join('/home/user/Paint-by-Example/dataset/ohouse_images/raw', file_name)):
            file_name = os.path.splitext(os.path.basename(bbox_path))[0] + '.PNG'
        if not os.path.isfile(os.path.join('/home/user/Paint-by-Example/dataset/ohouse_images/raw', file_name)):
            file_name = os.path.splitext(os.path.basename(bbox_path))[0] + '.webp'
        if not os.path.isfile(os.path.join('/home/user/Paint-by-Example/dataset/ohouse_images/raw', file_name)):
            file_name = os.path.splitext(os.path.basename(bbox_path))[0] + '.WEBP'
        if not os.path.isfile(os.path.join('/home/user/Paint-by-Example/dataset/ohouse_images/raw', file_name)):
            file_name = os.path.splitext(os.path.basename(bbox_path))[0] + '.jfif'
        if not os.path.isfile(os.path.join('/home/user/Paint-by-Example/dataset/ohouse_images/raw', file_name)):
            file_name = os.path.splitext(os.path.basename(bbox_path))[0] + '.JFIF'
        if not os.path.isfile(os.path.join('/home/user/Paint-by-Example/dataset/ohouse_images/raw', file_name)):
            file_name = os.path.splitext(os.path.basename(bbox_path))[0] + '.heic'
        if not os.path.isfile(os.path.join('/home/user/Paint-by-Example/dataset/ohouse_images/raw', file_name)):
            file_name = os.path.splitext(os.path.basename(bbox_path))[0] + '.HEIC'
        if not os.path.isfile(os.path.join('/home/user/Paint-by-Example/dataset/ohouse_images/raw', file_name)):
            file_name = os.path.splitext(os.path.basename(bbox_path))[0]
        if not os.path.isfile(os.path.join('/home/user/Paint-by-Example/dataset/ohouse_images/raw', file_name)):
            file_name = os.path.splitext(os.path.basename(bbox_path))[0] + '.tmp'
        if not os.path.isfile(os.path.join('/home/user/Paint-by-Example/dataset/ohouse_images/raw', file_name)):
            file_name = os.path.splitext(os.path.basename(bbox_path))[0] + '.TMP'

        img_path = os.path.join('/home/user/Paint-by-Example/dataset/ohouse_images/raw', file_name)
...
if __name__ == "__main__":
    dataset = OhouseImageDataset(state="train", dataset_dir="/home/user/Paint-by-Example/dataset/ohouse_images",
                                 image_size=512)
    count = 0
    ...
    # import os.path
    #
    # print(os.path.isfile("/home/user/Paint-by-Example/dataset/ohouse_images/raw/1406728082953_1.gif=1&w=720.jpg"))
